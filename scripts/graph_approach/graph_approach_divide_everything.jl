...
function main()
    ...
    for i in 1:max_iters
        ...
        if i == 1
            CSV.write(joinpath(@__DIR__, "graph_divide_everything_approach_$num_jobs.csv"), results)
        else
            CSV.write(joinpath(@__DIR__, "graph_divide_everything_approach_$num_jobs.csv"), results, append=true)
        end
